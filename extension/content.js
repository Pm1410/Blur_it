...
(function () {
  ...
  function applyBlurOverlay(img, result) {
    ...
    badge.innerHTML = `<span>⚠️ ${labelUpper} (${confPercent}%)</span><button class="nsfw-shield-reveal-btn" type="button">Reveal</button>`;

    const revealBtn = badge.querySelector(".nsfw-shield-reveal-btn");
